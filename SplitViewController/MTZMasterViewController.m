...
@interface MTZMasterViewController () {
...
- (void)viewDidLoad
{
	...
	self.detailViewController = (MTZDetailViewController *)[[self.splitViewController.viewControllers lastObject] topViewController];
}
